...
class _DatenschutzScreenState extends State<DatenschutzScreen> {
            ...
            child: Focus(
              ...
              child: Semantics(
                ...
                child: Column(
                  ...
                  ExcludeSemantics(child: const Divider()),
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Datenerfassung auf unserer Website', isMainSection: true),
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Wer ist verantwortlich für die Datenerfassung auf dieser Website?', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  Semantics(
                    label: 'Kontaktinformationen: Bayerischer Sportschützenbund e.V., Ingolstädter Landstraße 110, 85748 Garching-Hochbrück, Telefon: +49 89 316949-0, E-Mail: gs@bssb.bayern',
                    child: const ScaledText(
                  ...
                  UIConstants.verticalSpacingS,
                  Semantics(
                    label: 'Datenschutzbeauftragter: Herbert Isdebski, Scheibenhalde 1, 72160 Horb-Nordstetten, Telefon: (07451) 6 25 42 40, Sprechstunde für BSSB-Mitglieder: jeder erste Donnerstag im Monat, 16 bis 18 Uhr, E-Mail: datenschutz@bssb.de',
                    child: RichText(
                      text: TextSpan(
                        style: UIStyles.bodyStyle,
                        children: [
                  ...
                  ExcludeSemantics(child: const Divider()),
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Welche Daten werden erfasst und wie?', isMainSection: true),
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Server-Log-Dateien', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
                  ...
                  ExcludeSemantics(child: const Divider()),
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Cookie-Informationen', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
                  ...
                  ExcludeSemantics(child: const Divider()),
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Lokal gespeicherte Daten (SharedPreferences)', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
                  ...
                  ExcludeSemantics(child: const Divider()),
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Cache-Daten (mit Präfix "cache_")', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
                  ...
                  ExcludeSemantics(child: const Divider()),
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Wofür werden erhobene Daten genutzt?', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
                  ...
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Analyse-Tools und Tools von Drittanbietern', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
                  ...
                  ExcludeSemantics(child: const Divider()),
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Kontaktformulare, des Deutschen Schützenbundes', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
                  ...
                  ExcludeSemantics(child: const Divider()),
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Welche Rechte haben Sie bezüglich Ihrer Daten?', isMainSection: true),
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Auskunft, Sperrung, Löschung', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
                  ...
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Widerruf Ihrer Einwilligung zur Datenverarbeitung', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
                  ...
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Veröffentlichung von Daten und Fotos auf der Homepage', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
                  ...
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Beschwerderecht bei der zuständigen Aufsichtsbehörde', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
                  ...
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('Recht auf Datenübertragbarkeit', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
                  ...
                  UIConstants.verticalSpacingM,
                  _buildSectionHeader('SSL- bzw. TLS-Verschlüsselung', isMainSection: true),
                  UIConstants.verticalSpacingS,
                  const ScaledText(
  ...
  Widget _buildSectionHeader(String title, {bool isMainSection = false}) {
    return Semantics(
      ...
      child: ScaledText(
        title,
        style: isMainSection ? UIStyles.sectionTitleStyle : UIStyles.bodyStyle.copyWith(fontWeight: FontWeight.bold),
      ),
    );
  }
