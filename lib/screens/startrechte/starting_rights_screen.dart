...
class _StartingRightsScreenState extends State<StartingRightsScreen> {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      label: 'Startrechte verwalten. Startrechte bearbeiten und speichern.',
            ...
            Expanded(
              child:
                  _isLoading
                      ? Center(
                        child: Semantics(
                          label: 'Startrechte werden geladen',
                          child: CircularProgressIndicator(),
                        ),
                      )
                      : _errorMessage != null
                            ...
                            Wrap(
                              ...
                              children: [
                                Semantics(
                                  ...
                                  toggled: _digitalerPass,
                                  hint: 'Aktivieren oder deaktivieren',
                                  child: Checkbox(
