          ...
          child: Scaffold(
            ...
            body: ConstrainedBox(
              ...
              child: Semantics(
                container: true,
                liveRegion: true,
                label: 'Dialog - Wettkampfaktivität hinzufügen',
                hint:
                    'Formular zum Hinzufügen einer neuen Wettkampfaktivität. Füllen Sie alle Pflichtfelder aus',
                child: Stack(
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(UIConstants.spacingL),
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Semantics(
                                      header: true,
                                      label: 'Wettkampfaktivität hinzufügen',
                                      child: ScaledText(
                                        'Wettkampfaktivität hinzufügen',
                                        style: UIStyles.titleStyle.copyWith(
                                          fontSize:
                      ...
                      child: DialogFABs(
                        children: [
                          ...
                          Semantics(
                            ...
                            label: 'Wettkampfaktivität speichern',
                            hint:
                                _areAllCompulsoryFieldsFilled()
                                    ? 'Doppeltippen um die Wettkampfaktivität zu speichern und den Dialog zu schließen'
